...
@ccclass("InitialCreate")
@executeInEditMode(true)
export class InitialCreate extends Component {
  @property({ type: JsonAsset, tooltip: "拖入 Final_Initial_Gems.json" })
  ...
  createLayoutNodes() {
    if (!this.layoutJson) {
      console.warn("[InitialCreate] 未指定 layoutJson");
      return;
    }
