...
@ccclass("LayoutCreate")
@executeInEditMode(true)
export class LayoutCreate extends Component {
  @property({ type: JsonAsset, tooltip: "拖入 Final_Layout.json" })
  layoutJson: JsonAsset | null = null;

  @property({ tooltip: "生成前删除 Layout 下已有子节点" })
  ...
  createLayoutNodes() {
    if (!this.layoutJson) {
      console.warn("[LayoutCreate] 未指定 layoutJson");
      return;
    }
